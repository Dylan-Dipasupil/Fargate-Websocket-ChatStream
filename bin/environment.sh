...
slack_web_socket_token=$(prompt_for_value "SlackWebSocketToken" "Slack Web Socket Token" "none" "^xapp-[A-Za-z0-9-]+$")
...
jq -n \
  ...
  --arg slack_web_socket_token "$slack_web_socket_token" \
  '{
    ...
    SlackWebSocketToken: $slack_web_socket_token
